...
Memory_sizes MemSolver_Fast_DOC::computeForAllocations(unsigned int dim, unsigned int number_of_points, unsigned int number_of_centroids_max, unsigned int m, unsigned int sample_size, unsigned k, size_t freeMem){
	...
	model.addConstraint( (data_points.at(0) * sizeof(bool)) + sizeof(bool)
	...
	if(allMedioids){
		...
		result.size_of_pointsContained =       (size_t)((number_of_points+1)*sizeof(bool));
		result.size_of_pointsContained_count = (size_t)(model.getSolutionValue(size_of_pointsContained_count_max));
		result.size_of_index =                 (size_t)ceilf(model.getSolutionValue(size_of_index_max)+1);
	...
	// std::cout << " result.size_of_data: " << result.size_of_data
	// 		  << " result.size_of_samples: " << result.size_of_samples
	// 		  << " result.size_of_centroids: " << result.size_of_centroids
	// 		  << " result.size_of_findDim: " << result.size_of_centroids
	// 		  << " result.size_of_findDim_count: " << result.size_of_findDim_count
	// 		  << " result.size_of_pointsContained: " << result.size_of_pointsContained
	// 		  << " result.size_of_pointsContained_count: " << result.size_of_pointsContained_count
	// 		  << " result.size_of_index: " << result.size_of_index
	// 		  << " result.size_of_randomStates: " << result.size_of_randomStates
	// 		  << " result.size_of_bestDims: " << result.size_of_bestDims
	// 		  << " result.first_number_of_centroids: " << result.first_number_of_centroids << std::endl;
	...
	assert(result.size_of_bestDims              >= number_of_points*sizeof(bool)+sizeof(bool));
