...
int main() {
	...
	for(unsigned int i = 0; i < 10; i++){
		...
		auto ex6_2 = new TerminalComandExperiment("cd bin; nvprof --print-gpu-trace --print-api-trace --csv --log-file ../output/MineClusBestSmallTest_"+std::to_string(i)+".csv ./experimentMineClusBest", "MineClusBestSmall", "output");
		auto ex7_2 = new TerminalComandExperiment("cd bin; nvprof --print-gpu-trace --print-api-trace --csv --log-file ../output/MineClusBestMediumTest_"+std::to_string(i)+".csv ./experimentMineClusBestMedium", "MineClusBestMedium", "output");
