...
void PointsContainedDeviceNormalData::start(){
	...
	versionVec.push_back(whatDataIsInCentroidKernelFewPointsKernelVI); // <--- why is this here? and why only one and not the others?
	...
	//i think we should make iterations with the number of points
