...
class testDOCGPU : public ::testing::Test {
public:
...
TEST_F(testDOCGPU, testConstructor3){
...
TEST_F(testDOCGPU, testFindCluster){
...
TEST_F(testDOCGPU, testFindCluster2){
	std::vector<std::vector<float>*>* data = new std::vector<std::vector<float>*>;
	int a = 0;
...
TEST_F(testDOCGPU, _SLOW_testFindCluster3){
...
TEST_F(testDOCGPU, testFindKClusters){
	std::vector<std::vector<float>*>* data = data_4dim2cluster();
...
TEST_F(testDOCGPU, _SLOW_testFindKClusters2){
	std::vector<std::vector<float>*>* data = data_4dim2cluster();
...
TEST_F(testDOCGPU, testHelperFunctions){
...
TEST_F(testDOCGPU, _SLOW_testFindKClusters3){
	std::vector<std::vector<float>*>* data = data_4dim2cluster();


	DOCGPU d = DOCGPU(data, 0.1, 0.25, 7);
	d.setSeed(1);
...
TEST_F(testDOCGPU, testFindKClusters5){
	...
	DOCGPU d1 = DOCGPU(data1, 0.4, 0.25, 3);
	DOCGPU d2 = DOCGPU(data2, 0.4, 0.25, 3);
	DOCGPU d3 = DOCGPU(data3, 0.4, 0.25, 3);
...
TEST_F(testDOCGPU, _SLOW_testLarge5){
	std::vector<std::vector<float>*>* data = new std::vector<std::vector<float>*>;
...
TEST_F(testDOCGPU, testFindKClusters4){
	...
	DOCGPU d = DOCGPU(data, 0.1, 0.25, 6);
	std::vector<std::pair<std::vector<std::vector<float>*>*, std::vector<bool>*> > res = d.findKClusters(2);
...
TEST_F(testDOCGPU, testFindKClusters6){
...
TEST_F(testDOCGPU, testWithDataReader){
...
TEST_F(testDOCGPU, testWithDataReader2){
	DataGeneratorBuilder dgb;
	dgb.setSeed(1);
	Cluster small;
...
TEST_F(testDOCGPU, SLOW_testWithDataReader3){
	DataGeneratorBuilder dgb;
	dgb.setSeed(10);
	Cluster small;
	small.setAmmount(20);
...
TEST_F(testDOCGPU, SLOW_testWithDataReader4){
	DataGeneratorBuilder dgb;
	dgb.setSeed(1);
	Cluster small;
	small.setAmmount(1000);
...
TEST_F(testDOCGPU, SLOW_testWithDataReader5){
