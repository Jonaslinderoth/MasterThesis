...
TEST(testMuApriori, testFindBest5){
	...
	EXPECT_EQ(b->at(0)->item[0], 0);
	EXPECT_EQ(b->at(0)->item[1], 1);
	EXPECT_EQ(b->at(0)->item[2], 1);
	EXPECT_EQ(b->at(0)->item[3], 1);
}
...
TEST(testMuApriori, testFindBest2Clusters2){
	...
	EXPECT_EQ(((b->at(0)->item))[2], 1);
	EXPECT_EQ(((b->at(0)->item))[3], 1);
	EXPECT_EQ(((b->at(0)->item))[4], 1);
	EXPECT_EQ(((b->at(0)->item))[5], 1);
	EXPECT_EQ(((b->at(0)->item))[6], 1);
	EXPECT_EQ(((b->at(0)->item))[7], 1);
...
TEST(testMuApriori, _SLOW_testFindBest10Clusters){
	...
	EXPECT_EQ(b->at(0)->item.count(), 10);
...
TEST(testMuApriori, _SLOWtestFindBest20Clusters){
	...
	EXPECT_EQ(b->at(0)->score, a.mu(4000,4));
...
TEST(testMuApriori, _SUPER_SLOW_testFindBest20ClustersRandom){
	...
	EXPECT_EQ(b->at(0)->score, a.mu(1350,3));
