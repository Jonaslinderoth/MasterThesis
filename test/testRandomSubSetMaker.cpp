...
TEST(testRandomSubSetMaker, testMultible){
	...
	generateRandomIntArrayDevice(ids_d, d_randomStates , n , 10000 , 50);
...
TEST(testRandomSubSetMaker, testMultibleEqualSeed){
	...
	generateRandomIntArrayDevice(ids_d, d_randomStates , n , 1000 , 50);
	cudaMemcpy(ids_h, ids_d, sizeof(unsigned int) * n, cudaMemcpyDeviceToHost);
	...
	generateRandomIntArrayDevice(ids_d, d_randomStates2 , n , 1000 , 50);
	cudaMemcpy(ids2_h, ids_d, sizeof(unsigned int) * n, cudaMemcpyDeviceToHost);
...
TEST(testRandomSubSetMaker, testMultibleDifferentSizes){
	...
	generateRandomIntArrayDevice(ids_d, d_randomStates , n*2 , 100000 , 50);
	cudaMemcpy(ids_h, ids_d, sizeof(unsigned int) * n, cudaMemcpyDeviceToHost);
	
	generateRandomIntArrayDevice(ids_d, d_randomStates , n , 100000 , 50);
	cudaMemcpy(ids2_h, ids_d, sizeof(unsigned int) * n, cudaMemcpyDeviceToHost);
...
TEST(testRandomSubSetMaker, testMultibleDifferentSizes2){
	...
	generateRandomIntArrayDevice(ids_d, d_randomStates , n , 100000 , 50);
	generateRandomIntArrayDevice(ids2_d, d_randomStates , n2 , 100000 , 50);
