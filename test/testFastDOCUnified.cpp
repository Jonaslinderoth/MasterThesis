...
TEST(testFastDOCUnified, SLOW_testWithDataReaderUCluster){
...
TEST(testFastDOCUnified, SLOW_testWithDataReaderUCluster2){
	DataGeneratorBuilder dgb;
	dgb.setSeed(1);
	//Fast_DOC GPU Exception caught 16 1024 5: CU
...
TEST(testFastDOCUnified, SLOW_testWithDataReaderUCluster3){
	DataGeneratorBuilder dgb;
	dgb.setSeed(1);
	//Fast_DOC GPU Exception caught 16 1024 5: CU
...
TEST(testFastDOCUnified, SLOW_testWithDataReaderUCluster4){
	DataGeneratorBuilder dgb;
	dgb.setSeed(1);
	//Fast_DOC GPU Exception caught 16 1024 5: CU
